        ...
        <div class="row">
            <div class="col">
                ...
                <form action="validation-form/check.php" method="post">
                    ...
                    <a href="/register.php">Вход</a>
                </form>
            </div>
        </div>

        <?php else: ?>
            <p>Привет <?=$_COOKIE['user']?>. Хотите войти или выйти с аккаунта?<br>
            <a href="/crud.php" class="btn btn-primary">Войти</a> или <a href="/exit.php" class="btn btn-primary">Выйти</a></p>
        <?php endif; ?>
    </div>
</body>
</html>