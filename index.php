      ...
      <table class="table">
        <thead>
          ...
          <tr bgcolor="black">
            ...
            <th><button type="sumbit" class="btn btn-primary"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-search" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
