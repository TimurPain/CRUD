      ...
      <table class="table">
        <thead>
          ...
          <tr>
            ...
            <th><a href="allusers.php" class="btn btn-warning">Личные собщения</a> <a href="chat/chat.html" class="btn btn-warning">Общий чат</a> <a href="summernote/summernote.php" class="btn btn-outline-warning">Заметки</a></th>
            <th><a href="/exit.php" class="btn btn-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-box-arrow-left" viewBox="0 0 16 16">
